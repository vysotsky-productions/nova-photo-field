...
Nova.booting(function (Vue, router) {
    Vue.component('index-NovaPhotoField', __webpack_require__(18));
    Vue.component('detail-NovaPhotoField', __webpack_require__(21));
    Vue.component('form-NovaPhotoField', __webpack_require__(41));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__MediaLoading__ = __webpack_require__(45);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { MediaLoading: __WEBPACK_IMPORTED_MODULE_2__MediaLoading___default.a },
    ...
    methods: {
        loadPhoto: function loadPhoto(event) {
            var _this = this;

            console.log(1);

            convertBlobToBase64(event.target.files[0]).then(function (img) {
                console.log(img);
                _this.tmpUrl = img;
            });
        },
        ...
        upload: function upload(file) {
            ...
            // upload file && move data to cropper
            if (file) {
                var reader = new FileReader();
                reader.onload = function (event) {
                    Nova.$emit(_this2.cropperName, {
                        fileRead: event.target.result, // dataURl new image
                        originalFile: file.file, // original new image
                        ratio: _this2.field.params.ratio,
                        width: 1920,
                        height: 1080,
                        path: _this2.field.params.path,
        ...
        changeCrop: function changeCrop() {
            // move cropped file && data to cropper
    ...
    computed: {
        cropperName: function cropperName() {
            return 'cropper_MediaField_' + this.field.params.relation + this.field.params.resourceModelName + this.resourceId;
        },
        thumbPath: function thumbPath() {
            return '/thumbs/' + this.field.params.thumbs.adminThumbFolder + '/';
        },
    ...
    mounted: function mounted() {
        ...
        Nova.$on(this.typeResource + '-save_' + this.cropperName, function (data) {
            _this3.loading = true;
            _this3.handleChange(data.media.id);
            _this3.croppedMedia = data.media;
...
var update = __webpack_require__(48)("48b9b6cc", content, false, {});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(52), __webpack_require__(55).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(52), __webpack_require__(29)))
